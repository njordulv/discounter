  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <div className={`flex flex-wrap flex-start mb-3 gap-x-2 gap-y-1 ${isGridView ? '' : 'sm:mb-12'}`}>
...
export const GridViewSkeleton = forwardRef<HTMLDivElement>((_, ref) => {
  return (
    <div ref={ref} className="animate-pulse w-full max-w-[76px]">
...
export const ListingSkeleton = forwardRef<HTMLDivElement>((_, ref) => {
  return (
    <div ref={ref} className="animate-pulse w-full max-w-44">
...
export const DiscoverSkeleton = forwardRef<HTMLDivElement>((_, ref) => {
  return (
    <div ref={ref} className="animate-pulse w-full mb-4">
      <div className="w-full overflow-hidden">
...
export const IconSkeleton = forwardRef<HTMLDivElement>((_, ref) => {
  return (
    <div ref={ref} className="animate-pulse w-full">
      <div className="w-full overflow-hidden">
